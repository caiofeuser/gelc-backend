...
ProjectSchema.methods.addParticipant = function(participant,office='member') {
    
    switch(office) {

        case 'member':
            this.members.addToSet(participant._id);
            break;
        case 'secondcoordinator':
            this.secondCoordinator = participant._id;
            this.members.addToSet(participant._id);
            break;
        case 'coordinator':
            this.coordinator = participant._id;
            this.members.addToSet(participant._id);
            break;
        default:
            return;
